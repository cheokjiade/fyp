...
(
  ...
  publictransportservices_id varchar(50),
  publictransportservices_route_id INT,
  foreign key (session_hash, location_time) references location(session_hash, location_time),
...
*/
/*ALTER TABLE routepoint ADD COLUMN transportation_type varchar(50), ADD COLUMN publictransportservices_id varchar(50), ADD COLUMN publictransportservices_route_id INT;*/